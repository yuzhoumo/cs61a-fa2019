...
public class Main {
    ...
    public static void setupPersistence() throws IOException {
        boolean a = CAPERS_FOLDER.mkdir();
        boolean b = DOG_FOLDER.mkdir();
        boolean c = STORY_FILE.createNewFile();
    }
    ...
    public static void writeStory(String[] args) {
        ...
        contents = contents + args[1] + "\n";
        Utils.writeContents(STORY_FILE, contents);
