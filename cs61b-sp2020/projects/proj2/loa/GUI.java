...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuRadioButton("Settings->Auto Black", "black",
                false, (s) -> _pendingCommands.offer("auto black"));
        addMenuRadioButton("Settings->Manual Black", "black",
                true, (s) -> _pendingCommands.offer("manual black"));
        addMenuRadioButton("Settings->Auto White", "white",
                true, (s) -> _pendingCommands.offer("auto white"));
        addMenuRadioButton("Settings->Manual White", "white",
                false, (s) -> _pendingCommands.offer("manual white"));
        addMenuButton("Help->About", (s) -> displayText("About", ABOUT_TEXT));
        addMenuButton("Help->LOA", (s) -> displayText("LOA", HELP_TEXT));
